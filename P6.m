...
net6 = patternnet(hiddenLayerSizes);

net6.layers{end}.size = 8; % Tamaño de la salida 

% ajustamos manualmente la regularización L2
lambda = 0.01; % Parámetro de regularización L2
net6.performParam.regularization = lambda;


% parámetros de entrenamiento
net6.trainParam.epochs = 6000;  % Número de épocas
net6.trainParam.goal = 0;  % Objetivo de rendimiento
net6.trainParam.lr = 0.001;  % Tasa de aprendizaje
net6.trainParam.min_grad = 1e-6; % Criterio de convergencia basado en el gradiente
net6.trainParam.max_fail = 1000000000;  % Número máximo de fallos consecutivos

% Entreno la red neuronal
net6 = train(net6, trainingFeatures', trainingLabelsFeatures');

% Guardo la red 
save('red_neuronal_entrenada6.mat', 'net6');
...
predictions = net6(trainingFeatures');
...
% Utilizo la red neuronal para predecir etiquetas
predictions = net6(validationFeatures');
predictedLabels = vec2ind(predictions)';
...
% Utilizo la red neuronal para predecir etiquetas
predictions2 = net6(featuresEvaluation);
