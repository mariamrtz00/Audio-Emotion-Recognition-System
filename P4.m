...
audios_ravdess = dir('C:\Users\maria.martinez\OneDrive - VINCI Energies\Documseguentos\Nueva carpeta\1440audios\*.wav');
...
% Guarda las etiquetas tanto de numeros naturales como one hot
...
net4 = patternnet(hiddenLayerSizes);

net4.layers{end}.size = 8; % Tamaño de la salida (8 en este caso)


lambda = 0.01; % Parámetro de regularización L2
net2.performParam.regularization = lambda;
% parámetros de entrenamiento
net4.trainParam.epochs = 1000;  % Número de épocas
net4.trainParam.goal = 0;  % Objetivo de rendimiento
net4.trainParam.lr = 0.001;  % Tasa de aprendizaje
net4.trainParam.min_grad = 1e-6; % Criterio de convergencia basado en el gradiente
net4.trainParam.max_fail = 1000;  % Número máximo de fallos consecutivos

% Entreno la red neuronal
net4 = train(net4, trainingFeatures', trainingLabelsFeatures');

% Guardo la red 
save('red_neuronal_entrenada4.mat', 'net4');
...
predictions = net4(trainingFeatures');
...
% Utilizo la red neuronal para predecir etiquetas
predictions2 = net4(featuresEvaluation);
...
% Utilizo la red neuronal para predecir etiquetas
predictions = net4(validationFeatures');
predictedLabels = vec2ind(predictions)';
