...
allFeaturesMatrix = [chromaMatrix; zcrMatrix; mfccMatrix; rmsMatrix];
...
hiddenLayerSizes = [500, 200, 100, 100];
net8 = patternnet(hiddenLayerSizes);

net8.layers{end}.size = 8; % Tamaño de la salida (8 en este caso)
...
net8.performParam.regularization = lambda;

% Parámetros de entrenamiento
net8.trainParam.epochs = 6000;  % Número de épocas
net8.trainParam.goal = 0;  % Objetivo de rendimiento
net8.trainParam.lr = 0.001;  % Tasa de aprendizaje
net8.trainParam.min_grad = 1e-6; % Criterio de convergencia basado en el gradiente
net8.trainParam.max_fail = 1000000000;  % Número máximo de fallos consecutivos

% Entrenar la red neuronal
net8 = train(net8, trainingFeatures', trainingLabelsFeatures');

% Guardar la red 
save('red_neuronal_entrenada8.mat', 'net8');
...
predictions = net8(trainingFeatures');
...
% Utilizo la red neuronal para predecir etiquetas
predictions = net8(validationFeatures');
predictedLabels = vec2ind(predictions)';
...
% Utilizo la red neuronal para predecir etiquetas
predictions2 = net8(featuresEvaluation);
