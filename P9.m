...
hiddenLayerSizes = [500, 200, 200, 100];
net9 = patternnet(hiddenLayerSizes);

net9.layers{end}.size = 8; % Tamaño de la salida (8 en este caso)

% Cambiar la función de activación de las capas ocultas a ReLU
for i = 1:numel(hiddenLayerSizes)
    net9.layers{i}.transferFcn = 'poslin'; % ReLU
end

% Cambiar la función de activación de la capa de salida a Softmax
net9.layers{end}.transferFcn = 'softmax';

% Parámetros de entrenamiento
net9.trainParam.epochs = 6000;  % Número de épocas
net9.trainParam.goal = 0;  % Objetivo de rendimiento
net9.trainParam.lr = 0.001;  % Tasa de aprendizaje
net9.trainParam.min_grad = 1e-6; % Criterio de convergencia basado en el gradiente
net9.trainParam.max_fail = 1000;  % Número máximo de fallos consecutivos
...
% Utilizo la red neuronal para predecir etiquetas
predictions = net9(validationFeatures');
predictedLabels = vec2ind(predictions)';
...
% Utilizo la red neuronal para predecir etiquetas
predictions2 = net9(featuresEvaluation);
